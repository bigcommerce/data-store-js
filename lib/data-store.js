...
var DataStore = (function () {
    ...
    DataStore.prototype._dispatchObservableAction = function (action$, options) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            var transformedAction$ = _this._options.actionTransformer(Observable_1.Observable.from(action$)
                .map(function (action) {
                return options.queueId ? lodash_1.merge({}, action, { meta: { queueId: options.queueId } }) : action;
            }));
            _this._getDispatcher(options.queueId).next(Observable_1.Observable.from(transformedAction$)
